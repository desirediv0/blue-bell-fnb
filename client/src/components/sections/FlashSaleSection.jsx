        ...
        <Link href={`/products/${product.slug}`} className="group block">
            <div className="relative bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
                ...
                <div className="absolute top-0 right-0 z-10">
                    <div className="bg-gradient-to-br from-primary to-blue-600 text-white px-4 py-2 rounded-bl-2xl shadow-lg">
...
export function FlashSaleSection() {
    ...
    if (loading) {
        return (
            <section className="py-12 md:py-16 bg-gradient-to-br from-blue-50 via-white to-blue-50">
    ...
    return (
        <section className="py-12 md:py-16 bg-gradient-to-br from-blue-50 via-white to-blue-50 relative overflow-hidden">
            {/* Decorative Elements */}
            ...
            <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-tl from-indigo-200/40 to-transparent rounded-full blur-3xl translate-x-1/3 translate-y-1/3"></div>
            <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-gradient-to-br from-blue-100/30 to-transparent rounded-full blur-3xl -translate-x-1/2 -translate-y-1/2"></div>

            <div className="max-w-7xl mx-auto px-4 relative z-10">
                {/* Header Section */}
                <div className="text-center mb-10">
                    {/* Badge */}
                    <div className="inline-flex items-center gap-2 bg-gradient-to-r from-primary to-blue-600 text-white px-5 py-2 rounded-full shadow-lg mb-4">
                    ...
                    {/* Timer Section */}
                    <div className="inline-flex flex-col items-center gap-3 bg-white/80 backdrop-blur-sm px-6 py-4 rounded-2xl shadow-lg border border-blue-100">
                ...
                {currentSale.products.length > 5 && (
                    <div className="text-center mt-10">
                        <Link
                            ...
                            className="inline-flex items-center gap-3 bg-gradient-to-r from-primary to-blue-600 hover:from-blue-700 hover:to-primary text-white px-8 py-4 rounded-full font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
                        >
