        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="max-w-7xl mx-auto px-4 -mt-4 pb-12">
                <div className="grid md:grid-cols-2 gap-6">
                    {/* Email */}
                    <a href="mailto:Info@bluebellfnb.com" className="group bg-white rounded-2xl p-6 border border-gray-200 hover:border-primary/30 hover:shadow-lg transition-all duration-300 text-center">
                        ...
                        <p className="text-primary font-semibold text-sm mb-1 break-all">Info@bluebellfnb.com</p>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Get advice from our dairy specialists</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-3">
                                    <div className="w-10 h-10 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        <div className="text-center md:text-left">
                            <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-1">Ready to refresh your glass?</h2>
                            <p className="text-gray-600">Browse our collection of premium dairy products</p>
                        </div>
                        <Link href="/products">
