...
export const metadata = {
    title: "Why Choose Us | Bluebellfnb - India's Best Audio Store",
    description: "Discover why 50,000+ customers trust Bluebellfnb for professional audio equipment. Best prices, quality products, and excellent service.",
};
...
const reviews = [
    ...
    { name: "Suresh Reddy", rating: 5, text: "Been buying from Bluebellfnb for 5 years. Never disappointed.", location: "Hyderabad" },
